...
<head>
 ...
 function reg()
 {
	window.location.href="<%=path %>/admin/yonghu/zhuce.jsp";
 }
 </script>
</head>
<body>
...
<body>
	...
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  background="<%=path %>/img/login_bg.jpg">
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 40pt;">资产管理系统</div></td>
	 </tr>
	 <tr>
		<td width="559">
			<form name="ThisForm" method="POST" action="">
				<table width="410" height="198" border="0" align="right" cellpadding="0" cellspacing="0">
					...
					<tr>
					    <td width="54" height="22" valign="bottom">
						    <span class="STYLE15" >身份：</span>
						</td>
						<td width="356" valign="bottom">
					         <select class="INPUT_text" name="userType" style="height: 20px">
